...
<div class="main-content container-fluid pb-5">
            ...
            <div class="panel-card p-4 h-100 d-flex flex-column">
                ...
                <div class="flex-grow-1 overflow-auto pe-1 mb-3" style="min-height: 350px; max-height: 450px;" id="cartList">
                    <div class="h-100 d-flex flex-column align-items-center justify-content-center text-muted">
                        ...
                        <p class="mt-3 fw-bold mb-1">No hay productos en la lista</p>
                        <span class="small text-secondary">Escanea productos para agregarlos al despacho</span>
                    </div>
                </div>
    ...
    <script>
        ...
        function renderizarCarrito() {
            ...
            if (carrito.length === 0) {
                container.innerHTML = '<div class="h-100 d-flex flex-column align-items-center justify-content-center text-muted"><div class="bg-dark rounded-circle d-flex align-items-center justify-content-center" style="width: 80px; height: 80px;"><i class="bi bi-box-seam" style="font-size: 2.5rem; opacity: 0.5;"></i></div><p class="mt-3 fw-bold mb-1">No hay productos en la lista</p><span class="small text-secondary">Escanea productos para agregarlos al despacho</span></div>';
        ...
        function procesarDespacho() {
            ...
            Swal.fire({
                title: '¿Confirmar Salida?', text: "Se registrarán estas salidas de forma encriptada.",
                icon: 'warning', showCancelButton: true, confirmButtonColor: '#E50914', cancelButtonColor: '#444',
                confirmButtonText: 'Procesar', background: '#1c1c1c', color: '#fff'
            }).then((result) => {
