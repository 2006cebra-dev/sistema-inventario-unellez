...
<head>
    ...
    <style>
        ...
        * { font-family: 'Inter', sans-serif; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-footer {
            text-align: center; padding: 1.5rem 4%; margin-top: auto;
    ...
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('register') }}" class="text-start">
            ...
            <div class="mb-3">
                ...
                <input id="name" type="text" class="form-control auth-input @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Juan Pérez">
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input id="email" type="email" class="form-control auth-input @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="correo@ejemplo.com">
                @error('email')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input id="password" type="password" class="form-control auth-input @error('password') is-invalid @enderror" name="password" required autocomplete="new-password" placeholder="••••••••">
                @error('password')
                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input id="password-confirm" type="password" class="form-control auth-input" name="password_confirmation" required autocomplete="new-password" placeholder="••••••••">
            </div>

            <div class="d-grid">
                <button type="submit" class="btn-auth"><i class="bi bi-person-plus me-2"></i>Registrarse</button>
            </div>
        </form>
        ...
        <div class="auth-links" style="text-align: center;">
            ¿Ya tienes cuenta? <a href="{{ route('login') }}" class="text-white fw-bold">Inicia Sesión</a>
        </div>
    </div>
